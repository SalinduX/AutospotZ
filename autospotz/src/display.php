...
<body>
    <div class="grid-container">
      ...
      <aside id="sidebar">
        ...
        <ul class="sidebar-list">
          ...
          <li class="sidebar-list-item">
            <a href="display-um.php" target="_blank">
    ...
    <div class="container">
        ...
        <a type="button" class="btn float" href="admin.php">Add Slot</a>
    ...
    if($result){
        while( $row=mysqli_fetch_assoc($result)){
            ...
            <td>'.$status.'</td>
            <td>
            <a type="button" class="up-btn" href="update.php?updateid='.$slotid.'">Update</a>
            <a type="button" class="dlt-btn" href="delete.php?deleteid='.$slotid.'">Delete</a>   
            </td>
        </tr>';
           }
      }
